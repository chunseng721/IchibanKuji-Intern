...
const ProductEditScreen = ({ match, history }) => {
  ...
  const submitHandler = (e) => {
    ...
    if (product.description === 'Special Prize') {
      dispatch(
        updateCategory({
          _id: categorySelected._id,
          name: categorySelected.name,
          imageSrc: categorySelected.imageSrc,
          imageAlt: categorySelected.imageAlt,
          href: categorySelected.href,
          numberOfPrizes: categorySelected.numberOfPrizes,
          numberOfPrizesLeft: categorySelected.numberOfPrizesLeft,
          specialPrize: {
            specialPrizeName: name,
            specialImageSrc: imageSrc,
            specialImageAlt: imageAlt,
        }

...
export const CATEGORY_LIST_BY_SEARCH_REQUEST = 'CATEGORY_LIST_BY_SEARCH_REQUEST'
export const CATEGORY_LIST_BY_SEARCH_SUCCESS = 'CATEGORY_LIST_BY_SEARCH_SUCCESS'
export const CATEGORY_LIST_BY_SEARCH_FAIL = 'CATEGORY_LIST_BY_SEARCH_FAIL'
